...
def clinical_search(to_user_id, keyword):
    """生成临床查询助手小程序卡片
    ...
    Returns:
        str: 临床查询助手小程序卡片的XML格式
    """
    encoded_keyword = urllib.parse.quote_plus(keyword) # 对关键词进行URL编码

    # 生成小程序卡片XML
    card_xml = f"""<appmsg appid="" sdkver="0">
        <title>小胰宝临床试验一点通</title>
        <des>搜索临床信息: {keyword}</des> # 此处显示原始keyword
        <type>33</type>
        <url>https://mp.weixin.qq.com/mp/waerrpage?appid=wx993879dd5541124b&amp;type=upgrade&amp;upgradetype=3#wechat_redirect</url>
        <appattach>
                <cdnthumburl>3057020100044b30490201000204184fbfe702032df7fa02045cebd47602046838690a042438636465363236622d306337322d346138322d386662372d3638363530313134316466370204051808030201000405004c54a200</cdnthumburl>
                <cdnthumbmd5>d39462fbc9f9c0ffcbb259f6bad10cca</cdnthumbmd5>
                <cdnthumblength>47248</cdnthumblength>
                <cdnthumbwidth>1080</cdnthumbwidth>
                <cdnthumbheight>864</cdnthumbheight>
                <cdnthumbaeskey>a3bbd10246a964633ebd96d3680e9471</cdnthumbaeskey>
                <aeskey>a3bbd10246a964633ebd96d3680e9471</aeskey>
                <encryver>0</encryver>
                <filekey>wxid_v4cr5q0cdqiu22_8_1748566531</filekey>
        </appattach>
        <sourceusername>gh_7713a2e421b6@app</sourceusername>
        <sourcedisplayname>临床试验患者招募信息</sourcedisplayname>
        <md5>d39462fbc9f9c0ffcbb259f6bad10cca</md5>

        <weappinfo>
                <username><![CDATA[gh_7713a2e421b6@app]]></username>
                <appid><![CDATA[wx993879dd5541124b]]></appid>
                <type>2</type>
                <version>158</version>
                <weappiconurl><![CDATA[http://mmbiz.qpic.cn/mmbiz_png/uo0CAUUXsP7fGN6qVslicsbHRqSjKtuwfibiaOAlTyqg8icUh5QOOT75XibLibKHUEIpZFd9BHYAKd2licJPL7O0GLt6Q/640?wx_fmt=png&wxfrom=200]]></weappiconurl>
                <pagepath><![CDATA[pages/new/new-list.html?q={encoded_keyword}]]></pagepath>
                <shareId><![CDATA[0_wx993879dd5541124b_9eb01c8c8135ec467d47fa9c742a07fc_1748566531_0]]></shareId>
                <appservicetype>0</appservicetype>
                <brandofficialflag>0</brandofficialflag>
                <showRelievedBuyFlag>0</showRelievedBuyFlag>
                <hasRelievedBuyPlugin>0</hasRelievedBuyPlugin>
...
<commenturl />"""
    ...
    logger.info(f"[app_card] 生成临床查询助手卡片: {keyword}")
    return card_xml